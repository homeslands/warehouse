...
export class Notification extends Base {
  // title, body, link, language dùng để gửi notification tới Firebase FCM server
  @AutoMap()
  ...
  @AutoMap()
  @Column({ name: 'language_column', default: 'vi' })
  language: string;

  // FE dùng message để hiển thị notification trong UI
  @AutoMap()
