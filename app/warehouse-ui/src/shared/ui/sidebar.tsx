...
/**
 * Ctrl/⌘ + B không được giành phím khi người dùng đang gõ (ô nhập, soạn thảo, IME) hay đang ở trong
 * dialog — ở đó phím có nghĩa riêng (vd in đậm) hoặc sidebar nằm sau lớp phủ.
 */
...
function SidebarProvider({
  ...
  // id của phần tử sidebar, cho `aria-controls` của SidebarTrigger.
...
function Sidebar({
  ...
  /** Tên (ẩn) của ngăn trượt trên mobile — truyền chuỗi đã dịch. */
  mobileTitle?: string
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      // Ngăn trượt mobile chỉ có trong DOM khi mở: không trỏ vào phần tử không tồn tại.
...
// Bản shadcn render <main>; ở đây là <div> để AppShell tự đặt <main> quanh riêng vùng nội dung
// (header phải nằm ngoài main).
